    ...
    if (langToggle && currentFlag) {
        langToggle.addEventListener('click', () => {
            if (currentLang === 'en') {
                ...
                // To English - Set explicit translation to original language instead of just clearing
                setCookie('googtrans', '/en/en', 1);
                
                // Clear all possible variations of the cookie as backup
                ...
                // Clear storage that Google Translate might use
                try {
